          ...
          <CardContent className="grid gap-6 pt-6 lg:grid-cols-2">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-muted-foreground">Copy the item from its trade listing and paste the full text beginning with <span className="font-mono text-foreground">Item Class:</span>. We&apos;ll read the price from the <span className="font-mono text-foreground">Note:</span> line at the bottom.</p>
              </div>
